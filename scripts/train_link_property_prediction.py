...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--n-layers-pooler", default=1, type=int,
                   help="Hidden Linear->GELU stages in the pooler MLP (>= 1). 1 is the shape "
                        "this project has always used; each extra inserts a "
                        "Linear(hidden, hidden) -> GELU before the output layer.")
