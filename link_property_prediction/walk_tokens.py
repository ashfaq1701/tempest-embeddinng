...
class WalkTokens:
    ...
    cand_popularity: Optional[torch.Tensor] = None  # [Q]      edges on seed strictly before cutoff; 0 when cold
...
def build_query_walk_tokens(
    ...
    *,
    ...
    popularity = torch.from_numpy(
        np.ascontiguousarray(walk_gen.get_candidate_popularity(seeds_np, cutoffs_np))
